...
- `acme_certificate_use_sops_for_key`: Use [Mozilla sops](https://github.com/mozilla/sops) to encrypt private key. Needs `.sops.yaml` file inside the keys directory or somewhere up the directory chain.
